...
export class ProductService {
 ...
 private productlist:IProduct[]=[
  ...
  addProduct(product: any) {
    let newId = this.productlist[this.productlist.length - 1].id + 1
    this.productlist.unshift({ ...product, id: newId });
  }
 ...
 // pass data to subject
  ...
  getallUsersFromApi(page=1){
    return this.http.get(`https://www.mecallapi.com/api/users?page=${page}&per_page=5`);

  }

  setusertoapi(user:any){
    return this.http.post(`https://www.mecallapi.com/api/users/create`,user);
